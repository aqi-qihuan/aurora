...
public class ArticleController {
    ...
    @Operation(description = "获取置顶和推荐文章")
    ...
    @Operation(description = "根据id获取文章")
    ...
    @Operation(description = "校验文章访问密码")
    ...
    @Operation(description = "根据标签id获取文章")
    ...
    @Operation(description = "获取所有文章归档")
    ...
    @Operation(description = "修改文章是否置顶和推荐")
    ...
    @Operation(description = "删除或者恢复文章")
    ...
    @Operation(description = "根据id查看后台文章")
    ...
    public ResultVO<List<ArticleSearchDTO>> listArticlesBySearch(@RequestParam String keywords) {
        ConditionVO condition = ConditionVO.builder().keywords(keywords).build();

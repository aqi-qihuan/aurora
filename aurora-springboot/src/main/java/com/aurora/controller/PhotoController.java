...
public class PhotoController {
    ...
    @Operation(description = "根据相册id获取照片列表")
    ...
    @OptLog(optType = UPDATE)
    @Operation(description = "更新照片删除状态")
    ...
    @Operation(description = "根据相册id查看照片列表")

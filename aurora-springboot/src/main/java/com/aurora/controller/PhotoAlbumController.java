...
public class PhotoAlbumController {
    ...
    @Operation(description = "获取后台相册列表信息")
    ...
    @Operation(description = "根据id获取后台相册信息")
    ...
    @Operation(description = "根据id删除相册")
    @Parameter(name = "albumId", description = "相册id", required = true)

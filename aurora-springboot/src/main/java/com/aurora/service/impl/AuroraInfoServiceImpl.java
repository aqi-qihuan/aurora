    ...
    public AuroraHomeInfoDTO getAuroraHomeInfo() {
        try {
            CompletableFuture<Long> asyncArticleCount = CompletableFuture.supplyAsync(() -> {
                try {
                    return articleMapper.selectCount(new LambdaQueryWrapper<Article>().eq(Article::getIsDelete, FALSE));
                } catch (Exception e) {
                    throw new RuntimeException("Failed to get article count", e);
                }
            });
            CompletableFuture<Long> asyncCategoryCount = CompletableFuture.supplyAsync(() -> {
                try {
                    return categoryMapper.selectCount(null);
                } catch (Exception e) {
                    throw new RuntimeException("Failed to get category count", e);
                }
            });
            CompletableFuture<Long> asyncTagCount = CompletableFuture.supplyAsync(() -> {
                try {
                    ...
                    throw new RuntimeException("Failed to get tag count", e);
                }
            });
            CompletableFuture<Long> asyncTalkCount = CompletableFuture.supplyAsync(() -> {
                try {
                    return talkMapper.selectCount(null);
                } catch (Exception e) {
                    throw new RuntimeException("Failed to get talk count", e);
                }
            });
            CompletableFuture<WebsiteConfigDTO> asyncWebsiteConfig = CompletableFuture.supplyAsync(() -> {
                try {
                    ...
                    throw new RuntimeException("Failed to get website config", e);
                }
            });
            ...
            throw new RuntimeException("Failed to get aurora home info", e);
        }
    }

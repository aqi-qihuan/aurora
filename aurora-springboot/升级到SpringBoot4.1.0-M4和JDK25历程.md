# Aurora 博客系统 - 升级到 Spring Boot 4.1.0-M4 和 JDK 25 历程

<div align="center">


![Spring Boot](https://img.shields.io/badge/Spring%20Boot-4.1.0.M4-6DB33F?style=for-the-badge&logo=spring)
...
| :------------- | :----------------------------------------------------------- |
| 📅 **升级时间** | 2026-04-08                                                   |
| 🚀 **升级路线** | Spring Boot 3.5.10 + JDK 25 → Spring Boot 4.1.0-M4 + JDK 25  |
...
| 组件                     |         原版本          |           新版本           | 说明                      |
| :----------------------- | :---------------------: | :------------------------: | :------------------------ |
| **Spring Boot**          |         3.5.10          |        **4.1.0-M4**        | 基于 Spring Framework 7.0 |
...
| **Jackson**              |          3.1.0          |         **3.1.1**          | 修复安全漏洞 CVE          |
| **commons-lang3**        |         3.14.0          |         **3.15.0**         | 修复安全漏洞              |
| **aliyun-sdk-oss**       |         3.17.2          |         **3.18.0**         | 修复传递依赖漏洞          |
| **httpclient**           |      4.5.12 (传递)      |     **4.5.14** (显式)      | 修复安全漏洞              |
...
> **⚠️ 注意**：
>
> - SB 4.1.0-M4 启动时间增加是因为 Spring Framework 7.0 增加了更多初始化检查和 Bean 验证
> - 物理内存增加主要是由于 JDK 25 和 Spring Framework 7.0 的基础开销增加
> - **JVM Heap 使用量反而降低了 43%**，说明 SB 4.1.0-M4 的内存管理更高效
...
|  7   | 03:02 | 易受攻击的依赖项 (7个)    | Jackson 3.1.0、commons-lang3 3.14、httpclient 4.5.12、ini4j 0.5.4 等存在安全漏洞 | 升级到安全版本 + 排除传递依赖 + dependencyManagement 强制覆盖 |  ✅   |
...
| 依赖项                  |   漏洞版本    |     安全版本      | 修复方式                                        |
| :---------------------- | :-----------: | :---------------: | :---------------------------------------------- |
| **jackson-core**        |     3.1.0     |     **3.1.1**     | `dependencyManagement` 强制覆盖 SB 默认传递依赖 |
| **jackson-databind**    |     3.1.0     |     **3.1.1**     | 同上                                            |
| **jackson-annotations** |     旧版      |     **3.1.1**     | 同上                                            |
| **commons-lang3**       |    3.14.0     |    **3.15.0**     | 版本属性升级                                    |
| **aliyun-sdk-oss**      |    3.17.2     |    **3.18.0**     | 版本属性升级                                    |
| **httpclient**          | 4.5.12 (传递) | **4.5.14** (显式) | 从 aliyun-sdk-oss 排除旧版 + 显式引入安全版     |
| **ini4j**               | 0.5.4 (传递)  |      已排除       | 从 aliyun-sdk-oss 排除（不再需要）              |
...
<commons-lang3.version>3.15.0</commons-lang3.version>   <!-- 原 3.14.0 -->
<aliyun-oss.version>3.18.0</aliyun-oss.version>         <!-- 原 3.17.2 -->

<!-- dependencyManagement 新增：Jackson 安全版本 -->
<dependency>
    <groupId>com.fasterxml.jackson.core</groupId>
    <artifactId>jackson-core</artifactId>
    <version>${jackson.version}</version>
</dependency>
<!-- jackson-databind, jackson-annotations 同理 -->

<!-- dependencyManagement 新增：HttpClient 安全版本 -->
<dependency>
...
<!-- dependencies 中 aliyun-sdk-oss 排除漏洞传递依赖 -->
<dependency>
    <groupId>com.aliyun.oss</groupId>
    <artifactId>aliyun-sdk-oss</artifactId>
    <exclusions>
        <exclusion><groupId>org.apache.httpcomponents</groupId><artifactId>httpclient</artifactId></exclusion>
        <exclusion><groupId>org.ini4j</groupId><artifactId>ini4j</artifactId></exclusion>
    </exclusions>
</dependency>

<!-- 显式使用安全版本的 httpclient -->
<dependency>
    <groupId>org.apache.httpcomponents</groupId>
    <artifactId>httpclient</artifactId>
    <version>${httpclient.version}</version>
...
|  🔟   | **安全依赖管理**：第三方库（如 aliyun-sdk-oss）的传递依赖可能引入漏洞版本，应通过 `exclusion` + `dependencyManagement` 双重机制控制 |
...
<div align="center">
**文档版本**: v2.2 | **创建日期**: 2026-04-08 | **更新日期**: 2026-04-10  |

...
// CreateJob 创建定时任务
func (s *JobService) CreateJob(ctx context.Context, vo vo.JobVO) (*model.Job, error) {
	job := model.Job{
		JobName:      vo.JobName,
		JobGroup:     vo.JobGroup,
		InvokeTarget: vo.InvokeTarget, // 全限定类名或函数名
...
// UpdateJob 更新定时任务
func (s *JobService) UpdateJob(ctx context.Context, id uint, vo vo.JobVO) error {
	var job model.Job
	...
	updates := map[string]interface{}{
		"job_name":        vo.JobName,
		"job_group":       vo.JobGroup,
		"invoke_target":   vo.InvokeTarget,

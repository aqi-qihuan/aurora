...
[data-theme="dark"] .views-value {
  color: var(--neon-blue, #00D4FF);
  font-family: var(--font-mono, 'JetBrains Mono', monospace);
}
[data-theme="dark"] .views-bar { box-shadow: 0 0 8px rgba(59, 130, 246, 0.5); }
...
[data-theme="dark"] .action-btn.restore {
  background: rgba(0, 255, 136, 0.12);
  color: var(--neon-green, #00FF88);
}
[data-theme="dark"] .action-btn.restore:hover {
...
[data-theme="dark"] .dialog-icon-wrapper.warning {
  background: linear-gradient(135deg, rgba(255, 159, 10, 0.15) 0%, rgba(245, 158, 11, 0.25) 100%);
